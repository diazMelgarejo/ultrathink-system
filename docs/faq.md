...
A: Yes. Drop `bin/skills/` into your ECC Tools skills directory. It follows the SKILL.md standard and works alongside the 65+ skills in the ECC catalog.
...
**Q: When should I use the bin/skills vs multi-agent version?**
...
A: Yes! Add a `## Project-Specific Rules` section to `bin/skills/SKILL.md`. Specify your stack, patterns, and constraints. The skill architecture standard supports this in its "Degrees of Freedom" section.
