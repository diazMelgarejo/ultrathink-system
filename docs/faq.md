...
A: Yes. Drop `single-agent/` into your ECC Tools skills directory. It follows the SKILL.md standard and works alongside the 65+ skills in the ECC catalog.
...
**Q: When should I use the single-agent vs multi-agent version?**
...
A: Yes! Add a `## Project-Specific Rules` section to `single-agent/SKILL.md`. Specify your stack, patterns, and constraints. The skill architecture standard supports this in its "Degrees of Freedom" section.
