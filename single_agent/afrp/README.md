...
- **Cross-agent** when Perplexity-Tools delegates to ultrathink via the current MCP bridge, or via the backup HTTP `/ultrathink` path if that bridge is restored
